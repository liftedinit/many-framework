...
main() {
    ...
    tmux new-window -t "$tmux_name" -n kvstore-abci "./target/debug/many-abci -v -v --allow-addrs ./allow_addrs --many 127.0.0.1:8011 --many-app http://127.0.0.1:8010 --many-pem \"$pem_root/id4.pem\" --abci 127.0.0.1:16658 --tendermint http://127.0.0.1:16657/ 2>&1 | tee \"$root_dir/many-abci-kvstore.log\""
